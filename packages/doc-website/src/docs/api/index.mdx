...
import { CREATE_FS_PROJECT_EXAMPLE, CREATE_SCRIPT_COMMAND_EXAMPLE, FIND_WORKSPACE_BY_ALIAS_EXAMPLE, FIND_WORKSPACE_BY_NAME_EXAMPLE, FIND_WORKSPACE_BY_NAME_OR_ALIAS_EXAMPLE, FIND_WORKSPACES_BY_PATTERN_EXAMPLE, LIST_WORKSPACES_WITH_SCRIPT_EXAMPLE, MAP_SCRIPTS_TO_WORKSPACES_EXAMPLE, MULTI_METHOD_SCRIPTS_EXAMPLE, WORKSPACE_EXAMPLE } from '../../content/api/apiExamples';
...
Create a metadata that can be used to run a workspace's script.
<SyntaxHighlighter language="typescript">
