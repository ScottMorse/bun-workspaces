...
You can install the [CLI](/cli/index.html) in your project or simply use `bunx bun-workspaces`.
...
[See here](/config/index.html) for more information on the optional `bw.json` file, where you can
configure aliases for workspaces.

## Quick Start

[See the full CLI documentation](/cli/index.html) or continue for some quick examples.
